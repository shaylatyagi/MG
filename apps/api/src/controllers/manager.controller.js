// apps/api/src/controllers/manager.controller.js — DevSpec §manager
'use strict';
...
exports.list = async (req, res, next) => {
  try {
    ...
    const whereClause = ownerId
      ? "WHERE m.owner_id = $1 AND m.status != 'INACTIVE'"
...
// DELETE /api/manager/:id — soft-delete
exports.deactivate = async (req, res, next) => {
  try {
    ...
    if (rowCount === 0) throw new AppError('Manager not found', 404, 'NOT_FOUND');
