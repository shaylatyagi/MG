      ...
      <div style={{ marginLeft: '220px', flex: 1, padding: '32px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '24px' }}>
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            ...
            <button style={{ padding: '10px 20px', borderRadius: '8px', fontSize: '13px', fontWeight: '600', backgroundColor: '#8B5E3C', color: 'white' }}>Quick Pay Rent</button>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', gap: '16px', marginBottom: '24px' }}>
          <div style={{ flex: 1, backgroundColor: '#7D5235', borderRadius: '16px', padding: '28px', color: 'white' }}>
            ...
            <button style={{ backgroundColor: 'rgba(255,255,255,0.2)', color: 'white', padding: '10px 20px', borderRadius: '8px', fontSize: '13px', fontWeight: '600' }}>Withdraw to Bank</button>
          </div>
          ...
          <div style={{ flex: 2, backgroundColor: 'white', borderRadius: '16px', padding: '28px', border: '1px solid #E8E0D5' }}>
            ...
            <div style={{ backgroundColor: '#F3EDE5', borderRadius: '4px', height: '8px', marginBottom: '16px' }}>
              <div style={{ backgroundColor: '#8B5E3C', borderRadius: '4px', height: '8px', width: '78%' }}></div>
            </div>
            <button style={{ width: '100%', padding: '14px', backgroundColor: '#C49A6C', color: 'white', borderRadius: '8px', fontSize: '15px', fontWeight: '600' }}>Pay Balance via UPI</button>
          </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 0', borderBottom: '1px solid #F3EDE5' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: '12px', color: '#9CA3AF' }}>Aug 23, 10:15 AM</p>
                </div>
              </div>
